...
class MotionDiffusion(BaseArchitecture):
    ...
    def forward(self, **kwargs):
        ...
        if self.training:
            ...
            # model_kwargs = self.model.get_precompute_condition(device=motion.device, text=text, motion_length=kwargs['motion_length'])
            model_kwargs = self.model.get_precompute_condition(device=motion.device, text=text)
