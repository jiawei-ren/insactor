...
class BaseArchitecture(BaseModule):
    ...
    def split_results(self, results):
        ...
        for i in range(B):
            batch_output = dict()
            batch_output['motion'] = results['motion'][i]
            batch_output['pred_motion'] = results['pred_motion'][i]
            batch_output['motion_length'] = results['motion_length'][i]
            batch_output['motion_mask'] = results['motion_mask'][i]
